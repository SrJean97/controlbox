 ...
 */
export declare type AutoMappableProperties<TSource, TDestination> = AutoMappingOptionsConfiguration<TSource, TDestination, MappableKeys<Pick<TDestination, Extract<keyof TDestination, AutoMappingKeys<TSource, TDestination>>>>>;
/**
 * Picks properties that are not auto mappable.
 */
export declare type ExplicitProperties<TSource, TDestination> = BaseOptionsConfiguration<TSource, TDestination, MappableKeys<Pick<TDestination, Exclude<keyof TDestination, AutoMappingKeys<TSource, TDestination>>>>>;
/**
 * Destination member mapping configuration.
 */
export declare type MappingMembers<TSource, TDestination> = AutoMappableProperties<TSource, TDestination> & ExplicitProperties<TSource, TDestination>;
/**
 * Object key type.
 */
export declare type MemberInfo = string | number | symbol;
/**
 * Function that takes source and destination object and returns boolean.
 */
export declare type ConditionExpression<TSource = any, TDestination = any> = (source: TSource, destination: TDestination) => boolean;
export declare type ValueTransformer<TValue = any> = (value: TValue) => TValue;
export declare type MappingFunction<TSource = any, TDestination = any> = (source: TSource) => TDestination;
export declare type MapperFunction<TSource = any, TDestination = any, TResult = TDestination> = (source: TSource, destination: TDestination, context: ResolutionContext) => TResult;
...
export interface IMemberConfigurationExpression<TSource, TDestination, TMember> {
     ...
     */
    mapFromUsing<TSourceMember>(mappingFunction: (source: TSource) => TSourceMember, pair: MappingPair<TSourceMember extends Array<any> ? TSourceMember[0] : TSourceMember, TMember extends Array<any> ? TMember[0] : TMember> | MappingPair<TSourceMember extends Array<any> ? TSourceMember[0] : TSourceMember, TMember>): this;
    /**
...
export interface IAutoMemberConfigurationExpression<TSource, TDestination, TMember> extends IMemberConfigurationExpression<TSource, TDestination, TMember> {
    /**
...
export interface IProfileExpression {
     ...
     */
    createAutoMap<TSource, TDestination>(pair: MappingPair<TSource, TDestination>, members: Partial<AutoMappableProperties<TSource, TDestination>> & Required<ExplicitProperties<TSource, TDestination>>): IAutoMappingExpression<TSource, TDestination>;
    /**
...
export interface IMapper {
     ...
     */
    map<TSource, TDestination>(pair: MappingPair<TSource, TDestination>, source: TSource, destination?: TDestination): TDestination;
    /**
     * Executes mapping from the array of source objects to a new or existing destination objects.
     */
    map<TSource, TDestination>(pair: MappingPair<TSource, TDestination>, sources: TSource[], destination?: TDestination): TDestination[];
    map<TSource, TDestination>(pair: MappingPair<TSource, TDestination>, source: TSource | TSource[], destination?: TDestination): TDestination[] | TDestination;
}
